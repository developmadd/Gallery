...
import com.madd.madd.gallery.UI.Fragments.GalleryEditor.GalleryEditorContract;
import com.madd.madd.gallery.UI.Fragments.GalleryEditor.GalleryEditorPresenter;
...
public class GalleryEditorPresenterTest {


    GalleryEditorContract.View mockedView;
    GalleryEditorPresenter presenter;

    @Before
    public void setUp(){

        mockedView = mock(GalleryEditorContract.View.class);
